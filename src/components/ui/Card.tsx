...
const Card: React.FC<React.ComponentProps<'div'>> = ({ className, ...props }) => (
  <div className={cn('flex flex-col rounded-lg border bg-card text-card-foreground shadow-lg', className)} {...props} />
);
...
const CardFooter: React.FC<React.ComponentProps<'div'>> = ({ className, ...props }) => (
  <div className={cn('mt-auto flex items-center p-2 pt-0', className)} {...props} />
);
