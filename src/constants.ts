...
export const SKILLS = [
  ...
  { icon: 'aws', logo: LOGOS.AWS, score: 70 },
  { icon: 'aws2', logo: LOGOS.AWS2, score: 70 },
  { icon: 'css', logo: LOGOS.CSS, score: 80 },
  { icon: 'cucumber', logo: LOGOS.Cucumber, score: 30 },
  { icon: 'cypress', logo: LOGOS.Cypress, score: 45 },
  { icon: 'docker', logo: LOGOS.Docker, score: 70 },
  { icon: 'firebase', logo: LOGOS.Firebase, score: 50 },
  { icon: 'gcp', logo: LOGOS.GCP, score: 65 },
  { icon: 'git', logo: LOGOS.Git, score: 65 },
  { icon: 'graphql', logo: LOGOS.GraphQL, score: 80 },
  ...
  { icon: 'jest', logo: LOGOS.Jest, score: 40 },
  { icon: 'jetbrains', logo: LOGOS.JetBrains, score: 40 },
