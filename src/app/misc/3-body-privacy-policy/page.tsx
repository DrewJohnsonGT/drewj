  ...
  return (
    <div className="container">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to 3-Body, the software program provided by the Company.
          </p>
        </li>
        <li>
          <p>
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to 3-Body.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to 3-Body, accessible from{' '}
            <a href="https://3-body.vercel.app/home" rel="external nofollow noopener noreferrer" target="_blank">
