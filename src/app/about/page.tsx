...
const AboutImage = ({ alt, src }: { alt: string; src: string }) => {
  return <Image src={src} alt={alt} width={200} height={266} className="max-w-full rounded shadow-lg" />;
};

const AboutPage = () => {
  return (
    <div className="flex flex-col items-center justify-center">
      <h1 className="m-4 text-center text-2xl font-bold">Hey, I&apos;m Drew 👋</h1>
      ...
      <p className="text-center text-xl">
        I&apos;m a pretty big nerd, and I <b>love</b> making things. <br />I often have multiple ongoing 3D printing,
        embedded device/IoT, web/mobile app, SaaS or other miscellaneous projects on the side.{' '}
      </p>
      <br />
      <div className="my-4 mb-16 flex flex-wrap items-center justify-center gap-4">
      ...
      <br />
      <p className="text-center text-xl">A montage of my full Mandalorian build</p>
      <br />
      <iframe
